...
public static void main(String [] args){
	...
	public ParameterHolder(){
        ...
        public boolean isParamSet(String theAlias){
            if(!aliases.containsKey(theAlias))return false;
	...
	public	String stringSerialize() {
		...
		for(int i=0;i<allParamNames.size();i++){
			...
			if(paramType==stringParam)outs.append(getStringParamEncoded(allParamNames.get(i)));
			outs.append("_");
		}
	...
	public String getStringParam(String theAlias) {
                ...
                String fixedVersion=encodedVersion.replace("!!COLON!!", ":");
